              ...
              >
                ...
                <Link to="/provider">
                  <button type="button"className="custom-btn-home">
                    <span className= "p-1">GIVE FOOD</span>
                  </button>
                </Link>
                <Link to="/collector">
                  <button id="get-food" type="button" className="custom-btn-home ml-5">
                    <span className= "p-1">GET FOOD</span>
                  </button>
                </Link>
              </div>
            </div>
        ...
        >
          ...
          <div className="carousel-inner text-center">
            ...
            <h1 className="caro-title mt-4">WHO ARE WE?</h1>
                        ...
                        <p className="carousel-info">
                            We are a team of software developers inspired by the current economic
                            climate to meet the needs of those in search of fresh produce at no cost.
                        </p>
            </div>
            <div className="carousel-item">
